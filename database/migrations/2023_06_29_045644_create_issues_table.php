...
class CreateIssuesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('issues', function (Blueprint $table) {
            ...
            $table->longText('issue_desc')->nullable()->comment('課題内容');
            ...
            $table->unsignedBigInteger('assignee_id')->nullable()->comment('担当者ID');
            $table->unsignedBigInteger('milestone_id')->nullable()->comment('マイルストーンID');
