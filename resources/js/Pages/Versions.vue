...
const goToEdit = (version_id) => {
    location.href = route('edit-version', { 'version_id': version_id });
};
...
<template>
    ...
    <main class="container flex-1 py-5 mx-auto max-w-[1000px]">
        <div class="bg-slate-100 py-2 px-3 my-2">
            <div class="font-bold mb-2">バージョン一覧</div>
            
            <Link :href="route('create-version')">
                <button class="bg-blue-500 hover:bg-blue-700 text-white rounded py-1 px-4 ms-1">バージョン作成</button>
            </Link>
